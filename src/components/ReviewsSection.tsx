...
const reviews: ReviewItem[] = [
  ...
  { type: 'text', name: 'Monaswita', trip: 'Tirthan Riverside Retreat', text: 'I had an amazing experience during the yoga retreat at tirthan valley and am grateful for Shabista maam for being such an amazing host and making this trip so memorable', initial: 'M' },
  ...
  { type: 'text', name: 'Priyanka', trip: 'Jibhi & Tirthan Explorer', text: 'If you are looking for a sign to pack your bags, this is it! The experience was perfectly balanced—enough adventure to keep it exciting, but plenty of downtime to just breathe and take in the mountains. Highly recommend!', initial: 'P' },
